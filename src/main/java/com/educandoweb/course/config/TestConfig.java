...
public class TestConfig implements CommandLineRunner {
   ...
   private UserRepository userRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        Order o2 = new Order(null, Instant.parse("2026-04-12T03:42:10Z"),OrderStatus.WAITING_PAYMENT ,u2);
        Order o3 = new Order(null, Instant.parse("2026-04-10T15:21:22Z"), OrderStatus.WAITING_PAYMENT, u1);
       ...
       orderItemRepository.saveAll(Arrays.asList(oi1, oi2, oi3, oi4));
        ...
        Payment pay1 = new Payment(Instant.parse("2025-04-11T21:53:07Z"), o1);
        o1.setPayment(pay1);
